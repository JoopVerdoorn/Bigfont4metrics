...
//! Draw separator lines
        ...
        if (mTimerTime > 3599) {
            ...
            x = xul-10;
            dc.drawText(xul+26, 55, Graphics.FONT_NUMBER_MILD, fTimerSecs, Graphics.TEXT_JUSTIFY_LEFT|Graphics.TEXT_JUSTIFY_VCENTER);
        }
        ...
        dc.drawText(xtur, ytur, Garminfont3,  "Distance", Graphics.TEXT_JUSTIFY_LEFT|Graphics.TEXT_JUSTIFY_VCENTER);
        ...
        dc.drawText(xtbr, ytbr, Garminfont3, "Heartrate", Graphics.TEXT_JUSTIFY_LEFT|Graphics.TEXT_JUSTIFY_VCENTER);
